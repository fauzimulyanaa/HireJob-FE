      ...
      <form className='flex w-full justify-evenly flex-wrap' onSubmit={handleSubmit}>
        <section>
          <div className='wrapper-edit'>
            <div className='container-edit-profile px-8  bg-white w-[300px] md:w-[400px] lg:w-[400px] shadow-lg rounded-md'>
            ...
            <div className='btn-edit mt-4 flex flex-col mb-11 gap-4'>
              <button className=' w-[300px] md:w-[400px] lg:w-[400px] bg-[#5E50A1]  p-3 rounded-md text-white'>Simpan</button>
        ...
        <section>
          <div className='form-edit-company pb-56 '>
            <div className='wrapper-form bg-white w-[300px] p-10 rounded-lg h-[1200px] shadow-xl md:w-[700px] lg:w-[700px] '>
