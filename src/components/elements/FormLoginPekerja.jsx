...
import { loginActionWorker } from '../../redux/actions/Auth';

export default function FormInputLoginCompany() {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const authLogin = useSelector((state) => state.AuthLoginWorker);
  ...
  const onSubmit = (e) => {
    ...
    if (form.email === '' || form.password === '') {
      ...
      dispatch(loginActionWorker(form.email, form.password, navigate));
    }
  };
