      ...
      <section>
        <nav className="bg-white w-full ">
          <div className="content flex justify-between items-center mx-2 md:mx-10 px-4 md:px-9 py-2 md:py-6">
            <Link to={userLogin == "company" ? "/landing-home" : "/edit-worker"}>
            ...
            <div className="icon flex items-center space-x-3 md:space-x-5 relative">
              ...
              {isMenuOpen && (
                <div className="md:hidden absolute top-full left-[-460px] right-[-24px]   bg-white  shadow-md mt-2 transition duration-300 ease-in-out p-6">
              ...
              <div className="hidden md:flex md:space-x-5">
                ...
                <div className="flex items-center">
                  <div className="profiles border-r-2 border-black pr-5">
                    <img className="rounded-full" src={AuthLoginCompany?.data?.photo || AuthLoginWorker?.data?.photo} width={"50px"} height={"50px"} alt="Profile" onClick={toEditProfilePage} />
                  </div>
                </div>
