...
export default function Chating() {
  ...
  return (
    <>
      <div className="container flex flex-col md:flex-row md:items-start items-center p-24 ">
        <div className="popup bg-white md:w-2/4  w-[400px] me-5 mb-20">
